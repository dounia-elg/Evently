...
import { Ticket, ArrowRight, Mail, Lock, Loader2 } from 'lucide-react';
        ...
        <>
            ...
            <main className="min-h-screen bg-gray-200 flex items-center justify-center p-4 pt-32 pb-20">
                <div className="max-w-md w-full">
                    <Suspense fallback={
                        <div className="bg-white rounded-[3rem] shadow-2xl p-12 flex flex-col items-center justify-center min-h-[400px]">
                            <Loader2 className="w-12 h-12 text-red-600 animate-spin mb-4" />
                            <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Initializing Auth...</p>
                        </div>
                    }>
                        <LoginContent />
                    </Suspense>
